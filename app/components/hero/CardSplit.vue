<template>
    <div class="h-[calc(100vh-110px)] lg:h-[calc(100vh-160px)] mx-4 md:mx-16">
        ...
        <div class="xl:hidden flex flex-col gap-4 h-full">
            <!-- Image with overlapping content card -->
            <div class="relative flex-1 min-h-0">
                ...
                <div class="absolute bottom-4 left-4 right-4 z-10 flex flex-col text-primary-text bg-primary/90 backdrop-blur-sm rounded-[calc(var(--border-radius)*4)] p-6 md:p-8 shadow-lg shadow-black/40">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <!-- List Items -->
                        <div v-if="hero.list?.length" class="flex flex-wrap gap-x-6 gap-y-2">
                            <div
                        ...
                        <div v-if="hero.links?.length" class="hidden md:flex flex-wrap gap-4">
                            <UButton
            ...
            <!-- Buttons (mobile only, outside content card) -->
            <div v-if="hero.links?.length" class="md:hidden flex flex-wrap justify-center gap-4">
                <UButton
                    v-for="(linkItem, index) in hero.links"
                    :key="index"
                    :to="getLinkUrl(linkItem.link)"
